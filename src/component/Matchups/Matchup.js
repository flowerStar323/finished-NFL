...
class index extends Component {
    ...
    setSelectTeamID = (id) => {
        ...
        axios.post(`${ServerURL}/confirmaction`, { weekNum, entryname, userID }).then(e => {
            if (e.data === "true") {
                ...
                message: "Warning!", description: "You can't choose",
                duration: 2,
                style: { background: "#ffffcc" }
            });
    ...
    render() {
        ...
        return (
            <div style={{ height: "83vh", width: "100vw", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                <Card style={{
